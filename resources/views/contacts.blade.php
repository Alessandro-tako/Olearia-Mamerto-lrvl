        ...
        <div class="row">
            ...
            <div class="row justify-content-around g-3">
                ...
                <a href="https://www.facebook.com/Oleariamamerto/?locale=it_IT"
                    class="button-fb col-10 col-md-3 text-center" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://www.tiktok.com/@oleariamamerto" class="button-tt col-10 col-md-3 text-center"
                    target="_blank" rel="noopener noreferrer" aria-label="Segui Olearia Mamerto su TikTok">
                    <i class="bi bi-tiktok"></i>
                </a>

                <!-- Link a Instagram -->
                <a href="https://www.instagram.com/oleariamamerto/?locale=us&hl=am-et"
                    class="button-ig col-10 col-md-3 text-center" target="_blank" rel="noopener noreferrer"
