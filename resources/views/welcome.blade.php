<x-layout>
    ...
    <section class="container-fluid">
        <div class="row justify-content-center">
            <img class="col-12 col-md-8" src="{{ Storage::url('images/fotoprincipale.bmp') }}" alt="bottiglia con attestato e bicchieri">
            <p class="col-12 col-md-8 my-5">L’azienda agricola Olearia Mamerto è ubicata nelle colline poste ai piedi del Parco Nazionale dell’Aspromonte, ad un’altitudine pari a circa 300 metri sul livello del mare, nel Comune di Oppido Mamertina (RC).
            <br>
            ...
            <br>
            October Evoo è un olio pregiato ed esclusivo, per chi desidera un gusto unico ed inconfondibile, per viziare il palato.</p>
        </div>
    </section>
