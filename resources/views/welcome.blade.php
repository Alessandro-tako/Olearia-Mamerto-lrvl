            ...
            <div class="col-12 p-0">
                <div class="main-title-box d-flex justify-content-center align-items-center flex-column">
                    ...
                    <p class="mt-4 px-3 px-md-5">
                        ...
                        Scopri il gusto autentico della nostra terra.
                        <br>
        ...
        <div class="row justify-content-center">
            ...
            <figure class="col-12 col-md-8">
                <picture>
                    ...
                    <source srcset="{{ Storage::url('images/fotoprincipale.bmp') }}" type="image/jpeg">
                        ...
                        alt="Bottiglia di olio October EVOO con attestato e bicchieri"
            ...
            <article class="col-12 col-md-8 my-5" aria-label="Descrizione azienda Olearia Mamerto">
                <p>
                    ...
                    <br>
                    October Evoo è un olio pregiato ed esclusivo, per chi desidera un gusto unico ed inconfondibile, per
                    viziare il palato.
                </p>
            </article>
        </div>
